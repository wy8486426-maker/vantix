...
public class AccountRenewalLogController {
    private final AccountRenewalLogQueryService service;

    public AccountRenewalLogController(AccountRenewalLogQueryService service) {
    ...
    public Object page(@RequestParam(defaultValue = "1") long current,
        ...
        return CommonResultAdapter.success(service.page(new AccountRenewalLogPageQuery(current, size, keyword, status,
