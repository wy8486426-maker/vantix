...
public interface DealerCompanyMapper extends BaseMapper<DealerCompany> {
    ...
    @Insert({"<script>",
            "INSERT INTO dealer_company (company_id, company_name, parent_company_id, company_synced_at)",
            "VALUES",
            "<foreach collection='companies' item='company' separator=','>",
            "(#{company.companyId}, #{company.companyName}, NULL, #{company.companySyncedAt})",
            "</foreach>",
