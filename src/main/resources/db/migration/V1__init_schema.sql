...
CREATE TABLE service_account (
    ...
    owner_company_id BIGINT NOT NULL,
    assigned_user_id BIGINT NULL,
    account_source VARCHAR(32) NOT NULL DEFAULT 'EXCHANGE',
    source_service_code_id BIGINT NULL,
    exchange_batch_id BIGINT NULL,
    exchange_detail_id BIGINT NULL,
    test_issue_batch_id BIGINT NULL,
    history_import_batch_id BIGINT NULL,
    spec_code VARCHAR(32) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
    display_name VARCHAR(128) NOT NULL,
    service_type VARCHAR(64) NOT NULL,
    duration_days INT NOT NULL,
    ...
    KEY idx_service_account_source (account_source),
    KEY idx_service_account_test_issue_batch (test_issue_batch_id),
    KEY idx_service_account_history_import_batch (history_import_batch_id),
...
CREATE TABLE test_account_issue_batch (
    id BIGINT NOT NULL AUTO_INCREMENT,
    issue_batch_no VARCHAR(64) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
    request_id VARCHAR(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
    owner_company_id BIGINT NOT NULL,
    spec_code VARCHAR(32) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
    display_name VARCHAR(128) NOT NULL,
    ...
    updated_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
    PRIMARY KEY (id),
    UNIQUE KEY uk_test_account_issue_batch_no (issue_batch_no),
    UNIQUE KEY uk_test_account_issue_request (request_id),
    KEY idx_test_account_issue_owner_created (owner_company_id, created_at, id),
    KEY idx_test_account_issue_status (status, created_at, id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE history_account_import_batch (
    id BIGINT NOT NULL AUTO_INCREMENT,
    import_batch_no VARCHAR(64) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
    request_id VARCHAR(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
    owner_company_id BIGINT NOT NULL,
    spec_code VARCHAR(32) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
    display_name VARCHAR(128) NOT NULL,
    ...
    updated_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
    PRIMARY KEY (id),
    UNIQUE KEY uk_history_account_import_batch_no (import_batch_no),
    UNIQUE KEY uk_history_account_import_request (request_id),
    KEY idx_history_account_import_owner_created (owner_company_id, created_at, id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
